...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Offical Channel'
    ST_BN1_URL = 'https://t.me/ApnaTube'
    ST_BN2_NAME = 'Leech Group'
    ST_BN2_URL = 'https://t.me/PORNMIRRORLEECH'
    ST_MSG = '''<i>This bot can mirror all your links|files|torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.</i>
<b>Type {help_command} to get a list of available commands</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own @ApnaTube Mirror-Leech bot</i>'''
